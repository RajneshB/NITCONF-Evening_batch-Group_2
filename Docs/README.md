...
<p id="gdcalert1" ><span style="color: red;background-color: #ffffff; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to ./image.png). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert2">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
